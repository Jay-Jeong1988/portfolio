<template>
  <section>
    <div class="menus">
      ...
      <div class="lesson" name="lesson" @click="openProjectModal">
        <img src="../assets/images/play.svg" alt="play icon" />
        <p>Just Music</p>
      </div>
      <div name="question" @click="openProjectModal">
        <img src="../assets/images/car.svg" alt="question mark" />
        <p>JJ Ride</p>
      </div>
      <div name="membership" @click="openProjectModal">
        <img src="../assets/images/restaurant.svg" alt="membership card icon" />
        <p>Idealio</p>
      </div>
      <div name="community" @click="openProjectModal">
        <img src="../assets/images/letter.svg" alt="networking icon" />
        <p>Birthday Letter</p>
      </div>
      <div name="newFeed" @click="openProjectModal">
        <img src="../assets/images/zen-circle.svg" alt="new arrival" />
        <p>Codezen</p>
      </div>
    </div>
    <b-modal
    ...
    >
      <section class="photoSection" :style="`background-image: url(${computedContents.dynamicBg})`">
          <CustomSwiper v-if="swiperOn" :photoUrls="computedContents.dynamicPhotoUrls"/>
      </section>
      <section class="contentsContainer">
        <div class="contentsHeader">
          <button class="closeModalBtn" @click="$bvModal.hide('projectModal')">
...
export default {
  data() {
    return {
      ...
      swiperOn: false,
      modalContentName: "lesson", // Default Content Type
      contentsTypes: {
        lesson: {
          ...
          bgUrl: "http://ik.imagekit.io/kitkitkitit/portfolio/tr:q-100,w-1000e-usm-2-2-0.8-0.024/jm-bg00.png",
          photoUrls:[
  ...
  created() {},
  mounted() {
    setTimeout(()=>{this.swiperOn = true}, 100)
  },
  components: {
    CustomSwiper,
  }
