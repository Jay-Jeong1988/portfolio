  ...
  <section class="ProjectsSection" id="myProjects">
      ...
      <div>
        <div class="introduction">
          ...
          <p>
            ...
            <a
              href="https://github.com/Jay-Jeong1988/portfolio"
              target="_blank"
            >
    ...
    >
      <section class="photoSection" :style="`background-image: url(${project.bgUrl})`">
        <CustomSwiper
          v-if="$store.state.swiperOn"
          :photoUrls="project.photoUrls"
          :videoUrls="videosForDifferentBrowser"
        />
      </section>
  ...
  methods: {
    ...
    fetchProject(modalContentName) {
      ...
      const productionRequestUrl =
        "http://jayjeong.xyz:8081/api/v1/projects/getOne";
